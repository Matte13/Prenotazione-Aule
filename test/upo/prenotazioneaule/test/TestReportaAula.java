...
class TestReportaAula {
	...
	void setUp() throws Exception {
		...
		this.report = new ReportAula(this.data, this.a);
	...
	@Test
	void testGetAula() {
		assertEquals(this.a, this.report.getAula());
	}
	...
	@Test
	void testAddRecord() {
		this.report.addRecord(this.pren);
		for(Prenotazione p : this.report.getAllRecord())
			assertTrue(p.equals(this.pren));
	}
